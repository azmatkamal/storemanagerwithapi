...
class Nationalities extends Component {
  ...
  marknationality = (data) => {
    if (window.confirm("Would like to proceed with this action?")) {
      this.props.marknationality(data, this.toggleTableLoading);
    }
  };
  ...
  componentDidMount() {
    this.props.getNationalities(this.toggleTableLoading);
  }

  componentWillReceiveProps(nextProps) {
    if (nextProps && nextProps.nationalities) {
      this.setState({ nationalities: nextProps.nationalities });
    }
  }
                              ...
                              <td style={{ minWidth: "200px" }}>
                                ...
                                {!item.is_active && (
                                  <Button
                                    ...
                                    color="success"
                                    className="mr-2"
                                    onClick={this.marknationality.bind(this, {
                                      id: item._id,
                                      is_active: true,
