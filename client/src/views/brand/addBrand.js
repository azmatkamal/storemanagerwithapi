...
import { getBrands, addorUpdateBrand } from "../../redux/brand/action";
...
class AddBrand extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps && nextProps.brand && nextProps.brand.en_name) {
      this.setState({
        en_name: nextProps.brand.en_name,
        ar_name: nextProps.brand.ar_name,
        id: nextProps.brand._id,
      });
    }
...
export default withRouter(
  connect(mapDispatchToProps, { getBrands, addorUpdateBrand })(AddBrand)
);
