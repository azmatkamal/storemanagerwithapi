...
class Addsubcategory extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps && nextProps.subcategory && nextProps.subcategory.en_name) {
      this.setState({
  ...
  onSubmit = () => {
    ...
    this.props.addorUpdateSubCategory(
      formData,
...
export default withRouter(
  connect(mapDispatchToProps, { getSubCategories, addorUpdateSubCategory })(
    Addsubcategory
  )
);
