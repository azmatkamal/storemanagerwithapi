...
class Nationalities extends Component {
  ...
  markfield = (data) => {
    if (window.confirm("Would like to proceed with this action?")) {
      this.props.markfield(data, this.toggleTableLoading);
    }
  };
  ...
  updateRow = (nationality) => {
    ...
    if (!nationality) {
      ...
      this.props.selectField(nationality);
    }
  };

  componentDidMount() {
    this.props.getFields(this.toggleTableLoading);
  }

  componentWillReceiveProps(nextProps) {
    if (nextProps && nextProps.fields) {
                              ...
                              <td style={{ minWidth: "200px" }}>
                                ...
                                {!item.is_active && (
                                  <Button
                                    ...
                                    color="success"
                                    className="mr-2"
                                    onClick={this.markfield.bind(this, {
                                      id: item._id,
                                      is_active: true,
