...
class Nationalities extends Component {
  ...
  markplay = (data) => {
    if (window.confirm("Would like to proceed with this action?")) {
      this.props.markplay(data, this.toggleTableLoading);
    }
  };
  ...
  updateRow = (nationality) => {
    ...
    if (!nationality) {
      ...
      this.props.selectPlay(nationality);
    }
  };

  componentDidMount() {
    this.props.getPlays(this.toggleTableLoading);
  }

  componentWillReceiveProps(nextProps) {
    if (nextProps && nextProps.plays) {
      this.setState({ plays: nextProps.plays });
    }
  }
                              ...
                              <td style={{ minWidth: "200px" }}>
                                ...
                                {!item.is_active && (
                                  <Button
                                    ...
                                    color="success"
                                    className="mr-2"
                                    onClick={this.markplay.bind(this, {
                                      id: item._id,
                                      is_active: true,
