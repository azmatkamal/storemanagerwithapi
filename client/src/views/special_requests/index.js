...
class Nationalities extends Component {
  ...
  markspecial = (data) => {
    if (window.confirm("Would like to proceed with this action?")) {
      this.props.markspecial(data, this.toggleTableLoading);
    }
  };
  ...
  updateRow = (nationality) => {
    ...
    if (!nationality) {
      ...
      this.props.selectSpecial(nationality);
    }
  };

  componentDidMount() {
    this.props.getSpecials(this.toggleTableLoading);
  }

  componentWillReceiveProps(nextProps) {
    if (nextProps && nextProps.specials) {
      this.setState({ specials: nextProps.specials });
    }
  }
                              ...
                              <td style={{ minWidth: "200px" }}>
                                ...
                                {!item.is_active && (
                                  <Button
                                    ...
                                    color="success"
                                    className="mr-2"
                                    onClick={this.markspecial.bind(this, {
                                      id: item._id,
                                      is_active: true,
